...
function renderPerformanceMatrix() {
    ...
    const canvasBar = document.getElementById("performanceBarChart");
    const canvasPie = document.getElementById("distributionPieChart");
    ...
    performanceBarChart = new Chart(canvasBar,{
        type:"bar",
        data:{
    ...
    distributionPieChart = new Chart(canvasPie,{
        type:"pie",
        data:{
            labels:["Stability","Growth","Profitability"],
            datasets:[{ data:[stabilityScore,growthScore,profitabilityScore] }]
...
function showSection(sectionId, event) {
    ...
    // Force resize after section switch
    setTimeout(() => {
        revenueChart?.resize();
        profitChart?.resize();
        expenseChart?.resize();
